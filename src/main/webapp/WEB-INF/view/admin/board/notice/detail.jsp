                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>조회수</th>
                                <td>
                                	<fmt:formatNumber type="number" value="${n.hit }" pattern="#,###"/>
                                </td>
                            </tr>
                            <tr>
                                <th>첨부파일</th>
                                <td colspan="3" style="text-align:left;text-indent: 10px;">
                                	...
                                	<c:if test="${fn:endsWith(file,'.zip') } }">
                                		<c:set var="style" value="font-weight:bold;color:red;"/>
                                	</c:if>
                                	<c:forTokens var="file" items="${n.files }" delims="," varStatus="st">
                                		<a style="${style}" href="${file }">${fn:toUpperCase(file) }</a>
